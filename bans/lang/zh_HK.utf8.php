...
class Lang {
    public function __construct() {
        ...
        $array["generic.banned.by"] = $array["generic.banned"] . " 執行者";
        $array["generic.muted.by"] = $array["generic.muted"] . " 執行者";
        $array["generic.warned.by"] = $array["generic.warned"] . " 執行者";
        $array["generic.kicked.by"] = $array["generic.kicked"] . " 執行者";
